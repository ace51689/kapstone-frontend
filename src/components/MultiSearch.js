...
import { useStore, SET_SEARCH, SET_SEARCH_PAGE } from '../store/store'
...
const MultiSearch = () => {
  ...
  return (
    <div>
      ...
      <PaginationComponent pages={resObject.object.total_pages} setType={SET_SEARCH} pageType={SET_SEARCH_PAGE} apiCall={multiSearch}/>
      <ul>
        {
